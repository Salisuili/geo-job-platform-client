...
import LaborerDashboardLayout from '../layouts/LaborerDashboardLayout'; // Ensure this path is correct
  ...
  useEffect(() => {
    const fetchApplicationsCount = async () => {
      ...
      try {
        ...
        setApplicationsCount(data.applications.length); // Assuming 'applications' array is returned
      } catch (err) {
          ...
          <Col md={6} lg={4} className="mb-4">
            <Card className="shadow-sm border-0 h-100">
              <Card.Body>
                ...
                <Link to="/laborer/profile" className="btn btn-sm btn-outline-info mt-2">
                  View Profile
                </Link>
              </Card.Body>
            </Card>
